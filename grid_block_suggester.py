...
class GridBlockSuggester:
    def __init__(self, model_path='grid_block_model.pkl', features_path='feature_names.pkl'):
        # Load model
    ...
    def suggest(self, kernel_file, problem_size):
        ...
        if dimensionality == 1 or not (kernel_info['thread_usage']['uses_threadIdx_y'] or 
                                       kernel_info['thread_usage']['uses_threadIdx_z']):
            # 1D kernel
            candidates = [
                (32, 1, 1), (64, 1, 1), (128, 1, 1), (256, 1, 1), (512, 1, 1), (1024, 1, 1)
            ]
        ...
        for bx, by, bz in candidates:
            ...
            features = np.array([[
                ...
                dimensionality, compute_intensity, has_shared_memory,
